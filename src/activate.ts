...
class RuleSubscription {
	...
	private readonly componentRules: ProfileComponentRule[];
	private readonly pslRules: PslRule[];
	private readonly fileDefinitionRules: FileDefinitionRule[];
	private readonly methodRules: MethodRule[];
	private readonly memberRules: MemberRule[];
	private readonly propertyRules: PropertyRule[];
