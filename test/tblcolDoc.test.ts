...
describe("Table and Column Documentation tests", () => {
	...
	before(async () => {
		bracesInColDocDiagnostics = await utils.getDiagnostics(
			"ZTblColDocTst-Col1.COL",
			TblColDocumentation.name
		);
		withColDocDiagnostics = await utils.getDiagnostics(
			"ZTblColDocTst-Col2.COL",
			TblColDocumentation.name
		);
		withoutColDocDiagnostics = await utils.getDiagnostics(
			"ZTblColDocTst-Col3.COL",
			TblColDocumentation.name
		);
		withSpaceColDocDiagnostics = await utils.getDiagnostics(
			"ZTblColDocTst-Col4.COL",
			TblColDocumentation.name
		);
		bracesInsideColDefDiagnostics = await utils.getDiagnostics(
			"ZTblColDocTst-Col5.COL",
			TblColDocumentation.name
		);
		withoutClosedBracesColDiagnostics = await utils.getDiagnostics(
			"ZTblColDocTst-Col6.COL",
			TblColDocumentation.name
		);

		bracesInTblDocDiagnostics = await utils.getDiagnostics(
			"ZTblColDocTst1.TBL",
			TblColDocumentation.name
		);
		withTblDocDiagnostics = await utils.getDiagnostics(
			"ZTblColDocTst2.TBL",
			TblColDocumentation.name
		);
		withoutTblDocDiagnostics = await utils.getDiagnostics(
			"ZTblColDocTst3.TBL",
			TblColDocumentation.name
		);
		withSpaceTblDocDiagnostics = await utils.getDiagnostics(
			"ZTblColDocTst4.TBL",
			TblColDocumentation.name
		);
		bracesInsideTblDefDiagnostics = await utils.getDiagnostics(
			"ZTblColDocTst5.TBL",
			TblColDocumentation.name
		);
		withoutClosedBracesTblDiagnostics = await utils.getDiagnostics(
			"ZTblColDocTst6.TBL",
			TblColDocumentation.name
		);
	});
